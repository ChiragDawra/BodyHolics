...
export const strings = {
  ...
  landing: {
    ...
    clubMark: "BodyHolics club",
    joinNewCta: "Join as a new member",
    existingCta: "Existing member log in",
    scrollHint: "Hours, prices, and how busy it is",

    /**
     * The wall behind the launch screen. Decorative and `aria-hidden`, but
     * they are still English words on a screen, so they live here with every
     * other string rather than being buried in a component.
     */
    wall: [
      "Go hard or go home",
      "No pain no gain",
